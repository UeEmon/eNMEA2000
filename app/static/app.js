...
function clearDisplay(){rows=[];$('rows').replaceChildren();$('detail').textContent='センテンスを選択してください。';$('points').textContent='位置情報を待っています';firstFix=true;if(globe){globeEntities.forEach(entity=>globe.entities.remove(entity));globeEntities=[]}}
